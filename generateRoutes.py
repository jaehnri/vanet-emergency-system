...
for i in range(6):
  ...
  for y in range(5):
    ...
    if y != 4:
      route = route + " "
  route = route + f"\" color=\"yellow\" id=\"route_{i*2}\"/>\n"
  routes = routes + route
  ...
  for y in reversed(range(5)):
    ...
    if y != 0:
      route = route + " "
  route = route + f"\" color=\"yellow\" id=\"route_{i*2 + 1}\"/>\n"
  routes = routes + route
...
for i in range(6):
  ...
  for y in range(5):
    ...
    if y != 4:
      route = route + " "
  route = route + f"\" color=\"yellow\" id=\"route_{i*2 + 12}\"/>\n"
  routes = routes + route
  ...
  for y in reversed(range(5)):
    ...
    if y != 0:
      route = route + " "
  route = route + f"\" color=\"yellow\" id=\"route_{i*2+1 + 12}\"/>\n"
  routes = routes + route
